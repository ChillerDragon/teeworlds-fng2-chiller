...
MACRO_CONFIG_INT(SvScorelimit, sv_scorelimit, 1000, 0, 100000, CFGFLAG_SERVER, "Score limit (0 disables)")
MACRO_CONFIG_INT(SvTimelimit, sv_timelimit, 0, 0, 1000, CFGFLAG_SERVER, "Time limit in minutes (0 disables)")
MACRO_CONFIG_STR(SvGametype, sv_gametype, 32, "dm", CFGFLAG_SERVER, "Game type (fng2, fng2solo, fng2boom, fng2boomsolo)")
...
MACRO_CONFIG_INT(RcdEnable, rcd_enable, 0, 0, 8, CFGFLAG_SERVER, "Enable cheat detection")
MACRO_CONFIG_INT(RcdMaxWarnings, rcd_max_warnings, 50, 0, 100, CFGFLAG_SERVER, "Set the number of warnings before kick")
